...
export default function HomePage() {
  ...
  return (
    <div className="p-8">
      ...
      <h2 className="text-4xl font-semibold mb-6 text-gray-800 text-center">Users Table</h2>
          ...
          <thead className="bg-gray-100 text-left text-gray-600 font-semibold">
            <tr>
              ...
              {visibleColumns.includes("department") && (
                <th onClick={() => handleSort("department")} className="px-4 py-3 border-b cursor-pointer">Department</th>
              )}
              {visibleColumns.includes("location") && (
                <th onClick={() => handleSort("location")} className="px-4 py-3 border-b cursor-pointer">Location</th>
              )}
            ...
            {currentUsers.map((user) => (
              <tr key={user.id} className="hover:bg-gray-50 transition">
                ...
                {visibleColumns.includes("role") && <td className="px-4 py-3 border-b">{user.role}</td>}
                    {visibleColumns.includes("department") && <td className="px-4 py-3 border-b">{user.department}</td>}
               {visibleColumns.includes("location") && <td className="px-4 py-3 border-b">{user.location}</td>}
...
//   const totalPages = Math.ceil(filteredUsers.length / rowsPerPage);
//   const indexOfLast = currentPage * rowsPerPage;
//   const currentUsers = filteredUsers.slice(indexOfLast - rowsPerPage, indexOfLast);
...
//         <label className="px-4 py-2 border rounded-lg text-sm cursor-pointer hover:bg-gray-100">
//           Import CSV
//           <input type="file" accept=".csv" onChange={handleImportCSV} hidden />
//         </label>
...
//                 <th key={col} onClick={() => handleSort(col)} className="px-4 py-3 border-b cursor-pointer capitalize">
//                   {col}
//                 </th>
//               ))}
//             </tr>
...
//                 {visibleColumns.map(col => (
//                   <td key={col} className="px-4 py-3 border-b">{user[col]}</td>
//                 ))}
//               </tr>
//             ))}
//           </tbody>
...
//       {/* Pagination + Manage Columns */}
//       <div className="flex justify-between items-center mt-4">
//         <button onClick={() => setCurrentPage(p => p - 1)} disabled={currentPage === 1}
//           className="px-4 py-2 border rounded-lg disabled:opacity-50">Prev</button>
...
//         <div className="flex items-center gap-2 w-full max-w-xs border border-gray-300 px-3 py-2 rounded-full shadow-sm">
//           <input
//             type="text"
//             placeholder="Search names..."
//             value={search}
...
//           />
//           {search && (
//             <button onClick={() => setSearch("")} className="text-gray-500 hover:text-black transition">
//               <X size={18} />
//             </button>
//           )}
//         </div>
...
//       <h2 className="text-3xl font-semibold mb-4 text-gray-800 text-center">Users Data Table</h2>
...
//                   className="px-4 py-3 border-b cursor-pointer capitalize hover:bg-gray-200 transition border-4"
//                 >
//                   {col}
//                 </th>
//               ))}
...
//           <tbody>
//             {currentUsers.map((user) => (
//               <tr key={user.id} className="hover:bg-gray-50 transition border-4">
//                 {visibleColumns.map((col) => (
